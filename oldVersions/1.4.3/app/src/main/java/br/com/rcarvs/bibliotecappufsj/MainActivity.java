...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(SDK_INT < 14) {
            ...
            editTextLogin.setHintTextColor(Color.parseColor("#333333"));
            editTextLogin.setBackgroundColor(Color.parseColor("#FFFFFF"));
            editTextLogin.setTextColor(Color.parseColor("#333333"));
            editTextLogin.setHintTextColor(Color.parseColor("#333333"));

            editTextSenha.setHintTextColor(Color.parseColor("#333333"));
            editTextSenha.setBackgroundColor(Color.parseColor("#FFFFFF"));
            editTextSenha.setTextColor(Color.parseColor("#333333"));
            editTextSenha.setHintTextColor(Color.parseColor("#333333"));
        }
        ...
        if(this.isOnline(this)){
            ...
            botaoEntrar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    textoErroLogin.setText("");
                    textoErroLogin.setVisibility(View.GONE);
                                                                                            ...
                                                                                            if(response.length() > 0) {
                                                                                                ...
                                                                                                if(tem_nome_usuario == true){
                                                                                                    ...
                                                                                                    for (index = response.indexOf(expressao_unica_livros,index);index>=0;index=response.indexOf(expressao_unica_livros,index+1)){
                                                                                                        ...
                                                                                                        Integer posicao_acv_inicio = response.indexOf("acv=",index);

                                                                                                        Integer posicao_acv_fim = response.indexOf("&",posicao_acv_inicio+4);

                                                                                                        String acv_rodada = response.substring(posicao_acv_inicio+4,posicao_acv_fim);
                                                                                                        if(acv_rodada == "" || acv_rodada == "0" || acv_rodada == "00"){
                                                                                                            acv_rodada = acv_substituto;
                                                                                                        }
                                                                                                        ...
                                                                                                        livros = livros+identificador_rodada+"-%¬¹-"+nome_rodada+"-%¬¹-"+acv_rodada+"-%¬¹-"+devolver_rodada+"-%¬@-";
                                                                                                        acv_substituto = acv_rodada;
                                                                                                    }
                                                                                                    ...
                                                                                                    params.add(new BasicNameValuePair("ua", "1"));
