                                ...
                                public void onResponse(String response) {
                                    ...
                                    if (response.length() > 0) {
                                        ...
                                        if(response.contains("COMPROVANTE DE RENOVAÇÃO")){
                                            ...
                                            if(settings.getString("avaliou","N").contentEquals("N") && qtdeRenovada == 10){
                                                ...
                                                builder.setMessage("Olá "+splitNome[0]+"! Esta é o 10º renovação que você faz por aqui! Está gostando? Que tal deixar sua avaliação e comentário no Google Play? Desenvolvedores independentes adoram receber feedbacks!");
